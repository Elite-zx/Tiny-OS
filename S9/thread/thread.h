...
/**
 * struct task_struct - Process Control Block (PCB) or Thread Control Block
 * (TCB).
 * @self_kstack: Pointer to the top of the kernel stack for the thread.
 * @status: Current status of the thread.
 * @priority: Thread priority.
 * @name: Thread name.
 * @stack_magic: Stack boundary marker to prevent kernel stack overflows.
 *
 * This structure represents the main data structure for thread management,
 * containing all necessary information about a thread.
 */
struct task_struct {
